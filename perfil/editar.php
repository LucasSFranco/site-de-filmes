...
<html>
  ...
  <body>
    ...
    <div class="wrapper">
      <form action="?act=edit" method="POST" class="form <?php if(isset($errorMessages->form)) { echo 'global-error'; } ?>">
        <h1 class="form-title">EDITAR</h1>
        <input class="form-input <?php if(isset($errorMessages->nome)) { echo 'error'; } ?>" <?php if(isset($usuario->nome)) { echo "value=\"$usuario->nome\""; } ?> type="text" name="nome" placeholder="Nome" />
        ...
        <a class="button" href="./perfil.php"> <i class="icon fa fa-chevron-left"></i>Voltar </a>
